<%@ Page Title="" Language="C#" MasterPageFile="~/Hr/PL/HrLayout.Master" AutoEventWireup="true" CodeBehind="Leave Request Approved.aspx.cs" Inherits="Pos.Hr.PL.Leave_Request_Approved" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder111" runat="server">
   ...
   <asp:Button ID="Button13" runat="server"  ToolTip="طباعة تفاصيل الطلب" CssClass="imageButton13" OnClick="Button13_Click" />
        <asp:Button ID="Button14" runat="server"  ToolTip="طباعة المخالصة" CssClass="imageButton12" OnClick="Button14_Click" />
