<%@ Page Title="" Language="C#" MasterPageFile="~/Hr/PL/HrLayout.Master" AutoEventWireup="true" CodeBehind="UpdateShiftByEmployee.aspx.cs" Inherits="Pos.Hr.PL.UpdateShiftByEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder111" runat="server">
     ...
     <table align="center" cellspacing="4"  dir="rtl">
        ...
        <tr style="page-break-inside: avoid">
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="حذف/Delete" OnClick="Button1_Click"  />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr style="page-break-inside: avoid">
