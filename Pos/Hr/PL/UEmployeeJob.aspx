<%@ Page Title="" Language="C#" MasterPageFile="~/Hr/PL/HrLayout.Master" AutoEventWireup="true" CodeBehind="UEmployeeJob.aspx.cs" Inherits="Pos.Hr.PL.UEmployeeJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder111" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound">
                    <Columns>  
                         <asp:TemplateField>  
                    <ItemTemplate>  
                    ...
                    <EditItemTemplate>  
                        <asp:DropDownList ID="DropDownListmaanagement" runat="server" AppendDataBoundItems="True"  AutoPostBack="True" ></asp:DropDownList>
                    </EditItemTemplate>  
                </asp:TemplateField>
                    ...
                    <EditItemTemplate>  
                        <asp:DropDownList ID="DropDownListDepartmentName" runat="server" AppendDataBoundItems="True" AutoPostBack="True"></asp:DropDownList>
                    </EditItemTemplate>  
                </asp:TemplateField>
                    ...
                    <EditItemTemplate>  
                       <asp:DropDownList ID="DropDownListDirectmanager" runat="server" AppendDataBoundItems="True" AutoPostBack="True"></asp:DropDownList> 
                    </EditItemTemplate>  
                </asp:TemplateField>
                    ...
                    <EditItemTemplate>  
                       <asp:DropDownList ID="DropDownListheaddepartment" runat="server" AppendDataBoundItems="True" AutoPostBack="True"></asp:DropDownList>   
                    </EditItemTemplate>  
                </asp:TemplateField>
                    ...
                    <EditItemTemplate>  
                         <asp:DropDownList ID="DropDownListManagerDirector" runat="server" AppendDataBoundItems="True" AutoPostBack="True"></asp:DropDownList>
                    </EditItemTemplate>  
                </asp:TemplateField>
                    ...
                    <EditItemTemplate>  
                         <asp:TextBox ID="txt_cContractType"  Width="150px" autocomplete="off"  runat="server" Text='<%#Eval("cContractType") %>' TextMode="MultiLine"></asp:TextBox> 
                    ...
                    <EditItemTemplate> 
                        <asp:TextBox ID="txt_istcInshuranceType"  Width="150px" autocomplete="off"  runat="server" Text='<%#Eval("cInshuranceType") %>' TextMode="MultiLine"></asp:TextBox>  
