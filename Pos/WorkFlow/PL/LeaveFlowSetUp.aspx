<%@ Page Title="" Language="C#" MasterPageFile="~/WorkFlow/PL/WorkFlowLayout.Master" AutoEventWireup="true" CodeBehind="LeaveFlowSetUp.aspx.cs" Inherits="Pos.WorkFlow.PL.LeaveFlowSetUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder111" runat="server">
    <table align="center" cellspacing="4"  dir="rtl">
        ...
        <tr style="page-break-inside: avoid">
            <td class="auto-style1">
                <asp:Label ID="Label11" runat="server" Text="البارامتر /Paramater " ForeColor="Red"></asp:Label>
            </td>
            <td class="auto-style1">
                <asp:TextBox ID="TextBox1" autoomplete="off" placeholder="بحث باااسم البارامتر  " runat="server"></asp:TextBox>
        ...
        <tr style="page-break-inside: avoid">
            <td>
                <asp:Label ID="Label2" runat="server" Text="المستوي/Level" ForeColor="Red"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="TextBoxLevel" runat="server" autocomplete="off" placeholder="" ></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr style="page-break-inside: avoid">
