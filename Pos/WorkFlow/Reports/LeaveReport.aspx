<%@ Page Title="" Language="C#" MasterPageFile="~/WorkFlow/PL/WorkFlowLayout.Master" AutoEventWireup="true" CodeBehind="LeaveReport.aspx.cs" Inherits="Pos.WorkFlow.Reports.LeaveReport" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div>
            ...
            <rsweb:reportviewer id="ReportViewer1" Enabled="True" runat="server" font-names="Verdana" font-size="8pt" waitmessagefont-names="Verdana" waitmessagefont-size="14pt" width="790px" asyncrendering="False" >
                <LocalReport ReportPath="WorkFlow/Reports/LeaveReport1.rdlc">
